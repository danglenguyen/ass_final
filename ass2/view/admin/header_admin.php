...
<div class="header">
	<div class="container">
		<!--logo-->
			<div class="logo">
				<h1><a href="?action=home">REAL HOME</a></h1>
			</div>
		<!--//logo-->
		<div class="top-nav">
				...
				<li>
                    <?php
                        if(isset($_SESSION['email']))
                            echo '<a  href="?action=login">Logout</a>';
                        else    
                            echo '<a  href="?action=login"><i class="glyphicon glyphicon-user"> </i>Login</a>';
                    ?> 
                </li>
		...
		<div class="clearfix"> </div>
			<!---pop-up-box---->
				...
				<link href="../view/web/css/popuo-box.css" rel="stylesheet" type="text/css" media="all"/>
				<script src="../view/web/js/jquery.magnific-popup.js" type="text/javascript"></script>
			<!---//pop-up-box---->
				...
				<div class="sap_tabs">	
					 ...
					 <script src="../view/web/js/easyResponsiveTabs.js" type="text/javascript"></script>

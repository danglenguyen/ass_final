...
<div class="container">
    ...
    <div class="row" style="margin:25px 0 25px 0 ">
                                <div class="col-md-5">
                                    <form role="form" action="?action=insertPR_action" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Hình ảnh bài : </label>
                                            <input type="file" name="anhminhhoa" />
                                        </div>
                                        <div class="form-group">
                                            <label>Hình ảnh Slide : </label>
                                            <input type="file" name="anhminhhoa1" />
                                        </div>
                                        <div class="form-group">
                                            <label>Hình ảnh Slide : </label>
                                            <input type="file" name="anhminhhoa2" />
                                        </div>
                                        <div class="form-group">
                                            <label>Hình ảnh Slide : </label>
                                            <input type="file" name="anhminhhoa3" />
                                        </div>
                                        <div class="form-group">
                                            <label>Hình ảnh Slide : </label>
                                            <input type="file" name="anhminhhoa4" />
                                        </div>
                                        <div class="form-group">
                                            <label>Giá : </label>
								 ...
								 <div class="col-md-7">
									<div class="row col-md-10 col-md-offset-2 custyle">
										<table class="table table-striped custab">
											...
											<?php
												$lietkePR=new product();
												$result=$lietkePR->getList();
												while($set=$result->fetch()){
											?>
													<tr>
														...
														<td class="text-center"><a class='btn btn-info btn-xs' href="?action=updateLH"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
                                                        <a href="?action=deletePR_action&id=<?php echo $set['ProductID'] ?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Del</a></td>
													</tr> 
											<?php
												}
											?>                   
